...
static const struct proc_ops jit_fn_proc_fops = {
...
static const struct proc_ops jit_currentime_proc_fops = {
	.proc_flags     = PROC_ENTRY_PERMANENT,
	.proc_open		= jit_currenttime_proc_open,
	.proc_read		= seq_read,
	.proc_lseek		= seq_lseek,
	.proc_release	= single_release,
};
...
static const struct proc_ops jit_tasklet_proc_fops = {
	.proc_flags     = PROC_ENTRY_PERMANENT,
	.proc_open		= jit_tasklet_proc_open,
	.proc_read		= seq_read,
	.proc_lseek		= seq_lseek,
	.proc_release	= single_release,
};
